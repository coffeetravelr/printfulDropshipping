  ...
  return (
    <article className="border border-gray-200 rounded bg-white flex flex-col relative">
      ...
      <div className="p-3 flex flex-col sm:flex-row justify-center items-center">
        ...
        />
        <button
          className="snipcart-add-item w-full md:w-auto transition flex-shrink-0 py-2 px-4 border border-gray-300 hover:border-transparent shadow-sm text-sm font-medium bg-white text-gray-900 focus:text-white hover:bg-coffee hover:text-white focus:bg-coffee focus:outline-none rounded"
