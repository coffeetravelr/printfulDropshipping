  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        with your order, please let us know by contacting us at post@coffeetravelr.com!
      </p>

      <h2>Do you offer refunds?</h2>
      <p>
        Refunds are only offered to customers that receive the wrong items or
        damaged items. If any of these apply, please contact us at post@coffeetravelr.com
      ...
      <p>
        ...
        case, please let us know at post@coffeetravelr.com within a
